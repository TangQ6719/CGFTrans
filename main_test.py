...
def parse_agrs():
    ...
    parser.add_argument('--resume', type=str, default='', help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--load', type=str,  default='E:\Code\CGFTrans/results/iu_xray/2current_checkpoint.pth', help='whether to load the pre-trained model.')
