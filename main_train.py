...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='E:/Datasets/iu_xray/images/',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='E:/Datasets/iu_xray/annotation.json',
                        help='the path to the directory containing the data.')

    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default='iu_xray', choices=['iu_xray', 'LGK'],
    ...
    parser.add_argument('--num_layers_ed', type=int, default=3, help='the number of layers of Transformer.')
    ...
    parser.add_argument('--resume', type=str,  help='whether to resume the training from existing checkpoints.')# default='E:\Code\CGFTrans/results\iu_xray/model_best.pth',
...
def main():
    ...
    model = BaseModel(args, tokenizer)
